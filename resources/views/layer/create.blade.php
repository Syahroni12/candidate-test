...
<main class="max-w-[800px] mx-auto px-7 py-10">
    ...
    {{-- Page Header --}}
    <div class="mb-8">
        <h1 class="text-[26px] font-serif font-bold text-gray-900 mb-1 tracking-tight">Add New Layer</h1>
        <p class="text-[14px] text-gray-500">Add a layer to <span class="font-semibold text-gray-700">{{ $layup->name }}</span>.</p>
    </div>

    {{-- Form Card --}}
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <form action="{{ route('layer.store', $layup->id) }}" method="POST" class="p-8">
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="number" name="layer_order" id="layer_order" value="{{ old('layer_order') }}"
            ...
            <div class="grid grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="number" step="0.01" name="thickness" id="thickness" value="{{ old('thickness') }}"
            ...
            <div class="mb-6">
                ...
                <input type="number" step="0.01" name="angle" id="angle" value="{{ old('angle') }}"
