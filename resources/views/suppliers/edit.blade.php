...
<main class="max-w-[800px] mx-auto px-7 py-10">
    ...
    {{-- Page Header --}}
    <div class="mb-8">
        <h1 class="text-[26px] font-serif font-bold text-gray-900 mb-1 tracking-tight">Edit Supplier</h1>
        <p class="text-[14px] text-gray-500">Update supplier information in the system.</p>
    </div>
